...
struct gamepad_data {
    ...
    static constexpr const char* IOX2_TYPE_NAME = "gamepad_data";
};

inline auto operator<<(std::ostream& stream, const gamepad_data& value) -> std::ostream& {
    stream << "gamepad_data { dpad_x: " << value.dpad_x << ", dpad_y: " << value.dpad_y <<
