...
int main(int argc, char** argv) {
    ...
    {quad::common::BL_KNEE_0,       quad::common::FR_HIP_PITCH_0,     quad::common::FR_KNEE_0, 
     quad::common::FL_KNEE_0,       quad::common::FL_HIP_ROLL_0,      quad::common::BR_HIP_ROLL_0,
     quad::common::FR_HIP_ROLL_0,   quad::common::BR_HIP_ROLL_0,      quad::common::FL_HIP_PITCH_0,
     quad::common::BR_HIP_PITCH_0,  quad::common::BL_HIP_PITCH_0,     quad::common::BR_KNEE_0
    };
